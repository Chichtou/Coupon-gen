...
def generate_coupons():
    ...
    if request.method == 'POST':
        ...
        # Process CSV file with emails if provided.
        if file and file.filename != '':
            ...
            # If header row contains "email", skip it.
            ...
            with sqlite3.connect(DATABASE) as conn:
                ...
                conn.commit()
        # Otherwise, if a number is provided, generate that many coupons.
        elif count_str:
            try:
                count = int(count_str)
            except ValueError:
        ...
        # Create CSV output from generated coupons (including the QR code).
        output = io.StringIO()
        ...
        # Render the page with generated coupons and include a download link for CSV.
